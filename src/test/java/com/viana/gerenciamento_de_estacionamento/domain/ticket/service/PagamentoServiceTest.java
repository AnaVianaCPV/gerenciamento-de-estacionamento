...
class PagamentoServiceTest {
    ...
    void deveMarcarTicketComoPagoEmCasoDeSucesso() {
        ...
        assertEquals(com.viana.gerenciamento_de_estacionamento.domain.ticket.Status.PAGO, ticket.getStatus());
    ...
    void naoDeveAlterarStatusSePagamentoFalhar() {
        ...
        assertEquals(com.viana.gerenciamento_de_estacionamento.domain.ticket.Status.PENDENTE, ticket.getStatus());
